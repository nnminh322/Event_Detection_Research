...
def true_label_and_trigger(train_x, train_y, train_masks, train_span, class_num):
    ...
    for i in range(num_instance):
        ...
        true_one_hot_trigger_vector, true_one_hot_label_vector = (
    ...
    true_one_hot_trigger_vectors = [
        torch.tensor(x).to(device) for x in true_one_hot_trigger_vectors
    ]
    true_one_hot_label_vectors = [
        torch.tensor(x).to(device) for x in true_one_hot_label_vectors
    ]
