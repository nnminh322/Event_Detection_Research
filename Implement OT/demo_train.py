...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        for batch in dataloader:
            ...
            y_l = torch.where(label_ids < 0, torch.tensor(other_label, device=device), label_ids)
            ...
            L_task = F.binary_cross_entropy(pi_star_golden, (label_ids >= 0).float(), reduction='mean')
            ...
            LT_I = F.binary_cross_entropy(p_wi, (label_ids >= 0).float(), reduction='mean')
